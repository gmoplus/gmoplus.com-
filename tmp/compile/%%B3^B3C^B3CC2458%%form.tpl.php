<?php /* Smarty version 2.6.31, created on 2025-07-29 15:01:27
         compiled from /home/gmoplus/public_html/plugins/stripe/form.tpl */ ?>
<?php if ($this->_tpl_vars['isStripeConfigured']): ?>
    <!-- stripe plugin -->
    <style>
    <?php echo '
...
stripe/static/<?php echo $this->_tpl_vars['libFile']; ?>
.js" defer></script>
    <?php if ($this->_tpl_vars['libFile'] == 'lib.subscription'): ?>
        <div class="submit-cell">
            <div class="name"><?php echo $this->_tpl_vars['lang']['card_holder_name']; ?>
</div>
            <div class="field">
                <input type="text" name="card_name" id="card_name" class="wauto" maxlength="35" size="35" value="<?php echo $_POST['card_name']; ?>
" />
            </div>
        </div>
    <?php endif; ?>
...
<?php else: ?>
    ...
    $(document).ready(function() {
        printMessage(\'error\', \''; ?>
<?php echo $this->_tpl_vars['lang']['stripe_seller_payment_details_empty']; ?>
<?php echo '\');
    });
    '; ?>
