<?php /* Smarty version 2.6.31, created on 2025-04-24 11:26:09
         compiled from /home/gmoplus/public_html/templates/general_sunny/tpl/menus/user_navbar_menu.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'pageUrl', '/home/gmoplus/public_html/templates/general_sunny/tpl/menus/user_navbar_menu.tpl', 8, false),array('function', 'rlHook', '/home/gmoplus/public_html/templates/general_sunny/tpl/menus/user_navbar_menu.tpl', 62, false),array('modifier', 'replace', '/home/gmoplus/public_html/templates/general_sunny/tpl/menus/user_navbar_menu.tpl', 42, false),)), $this); ?>
                ...
                <li class="d-flex align-items-center justify-content-between position-relative<?php if ($this->_tpl_vars['mItem']['Key'] == 'my_messages' && $this->_tpl_vars['new_messages']): ?> messages<?php endif; ?>">
                    <?php if ((defined('IS_ESCORT') ? @IS_ESCORT : null) === true): ?>
                        <a<?php if ($this->_tpl_vars['page'] == $this->_tpl_vars['mItem']['Path']): ?> class="active"<?php endif; ?>
                           title="<?php echo ''; ?><?php if ($this->_tpl_vars['account_info']['Escort_Type'] == 'personal' && ( $this->_tpl_vars['mItem']['Key'] == 'add_listing' || $this->_tpl_vars['mItem']['Controller'] == 'my_listings' )): ?><?php echo ''; ?><?php echo $this->_tpl_vars['lang']['escort_my_profile']; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo $this->_tpl_vars['mItem']['title']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?>
"
                           href="<?php echo $this->_tpl_vars['accountMenuHref']; ?>
"
                        >
                            <?php if ($this->_tpl_vars['account_info']['Escort_Type'] == 'personal' && ( $this->_tpl_vars['mItem']['Key'] == 'add_listing' || $this->_tpl_vars['mItem']['Controller'] == 'my_listings' )): ?>
