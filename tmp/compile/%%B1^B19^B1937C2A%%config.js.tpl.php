<?php /* Smarty version 2.6.31, created on 2025-05-30 13:52:45
         compiled from /home/gmoplus/public_html/plugins/street_view/config.js.tpl */ ?>
<!-- street view js config -->

<script class="fl-js-dynamic">
var streetViewConfig = [];
streetViewConfig['provider'] = '<?php echo $this->_tpl_vars['config']['street_view_provider']; ?>
';
streetViewConfig['mode'] = '<?php echo $this->_tpl_vars['config']['street_view_mode']; ?>
';
streetViewConfig['google_api_key'] = '<?php echo $this->_tpl_vars['config']['street_view_google_key']; ?>
';
streetViewConfig['yandex_api_key'] = '<?php echo $this->_tpl_vars['config']['street_view_yandex_key']; ?>
';
