<?php /* Smarty version 2.6.31, created on 2025-04-14 18:38:26
         compiled from /home/gmoplus/public_html/templates/general_sunny/tpl/blocks/smart_search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'pageUrl', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/smart_search.tpl', 4, false),)), $this); ?>
<!-- smart search tpl -->

<div class="smart-search position-relative w-100">
    <form autocomplete="off" class="smart-search__form d-flex w-100" method="post" action="<?php echo $this->_plugins['function']['pageUrl'][0][0]->pageUrl(array('key' => 'search'), $this);?>
#keyword_tab">
        <input type="hidden" name="action" value="search" />
        <input type="hidden" name="form" value="keyword_search" />

        <div class="w-100 position-relative">
            <input name="f[keyword_search]" autocomplete="off" class="smart-search__input w-100" type="text" placeholder="<?php echo $this->_tpl_vars['lang']['keyword_search_hint']; ?>
" />
        ...
        <input class="smart-search__submit" type="submit" value="<?php echo $this->_tpl_vars['lang']['search']; ?>
" />
    </form>

    <div class="smart-search__results-wrapper">
        <div class="smart-search__results-cont w-100">
            <div class="text-center pt-3 pb-3 date"><?php echo $this->_tpl_vars['lang']['loading']; ?>
</div>
        </div>
    </div>
</div>
