<?php /* Smarty version 2.6.31, created on 2025-05-30 13:52:45
         compiled from /home/gmoplus/public_html/templates/general_sunny/components/listing-details-gallery/_listing-details-gallery.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/home/gmoplus/public_html/templates/general_sunny/components/listing-details-gallery/_listing-details-gallery.tpl', 15, false),array('modifier', 'count', '/home/gmoplus/public_html/templates/general_sunny/components/listing-details-gallery/_listing-details-gallery.tpl', 62, false),array('function', 'pageUrl', '/home/gmoplus/public_html/templates/general_sunny/components/listing-details-gallery/_listing-details-gallery.tpl', 27, false),array('function', 'rlHook', '/home/gmoplus/public_html/templates/general_sunny/components/listing-details-gallery/_listing-details-gallery.tpl', 41, false),)), $this); ?>
<!-- listing picture gallery tpl -->

<div class="gallery position-relative">
    <div id="media" data-view="gallery">
        <div class="preview<?php if ($this->_tpl_vars['photos']['0']['Type'] == 'video'): ?> <?php if ($this->_tpl_vars['photos']['0']['video_key']): ?>video<?php else: ?>local<?php endif; ?><?php endif; ?>">
            <iframe id="yt_iframe" frameBorder="0" allow="autoplay"></iframe>

            <?php if ($this->_tpl_vars['photos']['0']['Type'] == 'video' && ! $this->_tpl_vars['photos']['0']['video_key']): ?>
...
" type="video/mp4"></source>
            ...
            <img class="default-picture"
                 title="<?php if ($this->_tpl_vars['photos']['0']['Description']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['photos']['0']['Description'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
<?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['pageInfo']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
<?php endif; ?>"
...
">
                        <?php if (( ( ! $this->_tpl_vars['allow_photos'] && ($this->_foreach['photosF']['iteration'] <= 1) ) || $this->_tpl_vars['allow_photos'] ) && $this->_tpl_vars['photo']['Type'] == 'video' && ! $this->_tpl_vars['photo']['video_key']): ?>
                            <video><source src="<?php echo $this->_tpl_vars['photo']['Original']; ?>
" type="video/mp4"></source></video>
                        <?php else: ?>
                            <img alt="<?php if ($this->_tpl_vars['photo']['Description']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['photo']['Description'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
<?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['pageInfo']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
<?php endif; ?>"
...
?>
        ...
        galleryData.push(<?php echo '{'; ?>
            ...
            type: '<?php if ($this->_tpl_vars['photo']['Type'] == 'video'): ?><?php if ($this->_tpl_vars['photo']['video_key']): ?>iframe<?php else: ?>html5video<?php endif; ?><?php else: ?>image<?php endif; ?>',
            src: '<?php if ($this->_tpl_vars['photo']['Type'] == 'video'): ?><?php if ($this->_tpl_vars['photo']['video_key']): ?><?php echo $this->_tpl_vars['photo']['href']; ?>
<?php else: ?><?php echo $this->_tpl_vars['photo']['Original']; ?>
...
<?php endif; ?>",
            videoType: "<?php if ($this->_tpl_vars['photo']['Type'] == 'video' && $this->_tpl_vars['photo']['video_key']): ?><?php echo $this->_tpl_vars['photo']['Original']; ?>
<?php endif; ?>",
        <?php echo '}'; ?>
);
    <?php endforeach; endif; unset($_from); ?>
