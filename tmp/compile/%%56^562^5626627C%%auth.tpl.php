<?php /* Smarty version 2.6.31, created on 2025-10-10 10:05:46
         compiled from /home/gmoplus/public_html/plugins/shoppingCart/view/auth.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'pageUrl', '/home/gmoplus/public_html/plugins/shoppingCart/view/auth.tpl', 15, false),array('modifier', 'count', '/home/gmoplus/public_html/plugins/shoppingCart/view/auth.tpl', 28, false),)), $this); ?>
<!-- user authorization form -->

<div class="auth"><?php echo '<div class="cell"><div><div class="caption">'; ?><?php echo $this->_tpl_vars['lang']['sign_in']; ?><?php echo '</div><div class="name">'; ?><?php if ($this->_tpl_vars['config']['account_login_mode'] == 'email'): ?><?php echo ''; ?><?php echo $this->_tpl_vars['lang']['mail']; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo $this->_tpl_vars['lang']['username']; ?><?php echo ''; ?><?php endif; ?><?php echo '</div><input class="w210" type="text" name="login[username]" maxlength="100" value="'; ?><?php echo $_POST['login']['username']; ?><?php echo '" /><div class="name">'; ?><?php echo $this->_tpl_vars['lang']['password']; ?><?php echo '</div><input class="w210" type="password" name="login[password]" maxlength="100" /><div class="mt-3"><a target="_blank" title="'; ?><?php echo $this->_tpl_vars['lang']['remind_pass']; ?><?php echo '" href="'; ?><?php echo $this->_plugins['function']['pageUrl'][0][0]->pageUrl(array('key' => 'remind'), $this);?><?php echo '">'; ?><?php echo $this->_tpl_vars['lang']['forgot_pass']; ?><?php echo '</a></div></div></div><div class="divider">'; ?><?php echo $this->_tpl_vars['lang']['or']; ?><?php echo '</div><div class="cell">'; ?><?php $this->assign('selected_atype', ''); ?><?php echo '<div><div class="caption">'; ?><?php echo $this->_tpl_vars['lang']['sign_up']; ?><?php echo '</div>'; ?><?php if (! $this->_tpl_vars['quick_types'] || ( $this->_tpl_vars['quick_types'] && count($this->_tpl_vars['quick_types']) <= 1 )): ?><?php echo '<div class="name">'; ?><?php echo $this->_tpl_vars['lang']['your_name']; ?><?php echo '</div><input class="w210" type="text" name="register[name]" maxlength="100" value="'; ?><?php echo $_POST['register']['name']; ?><?php echo '" />'; ?><?php endif; ?><?php echo '<div class="name">'; ?><?php echo $this->_tpl_vars['lang']['your_email']; ?><?php echo '</div><input class="w210" type="text" name="register[email]" maxlength="100" value="'; ?><?php echo $_POST['register']['email']; ?><?php echo '"  />'; ?><?php if ($this->_tpl_vars['quick_types'] && count($this->_tpl_vars['quick_types']) > 1): ?><?php echo '<div class="name">'; ?><?php echo $this->_tpl_vars['lang']['account_type']; ?><?php echo '</div><select class="w120" name="register[type]">'; ?><?php $_from = $this->_tpl_vars['quick_types']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['acTypes'] = array('total' => count($_from), 'iteration' => 0);
