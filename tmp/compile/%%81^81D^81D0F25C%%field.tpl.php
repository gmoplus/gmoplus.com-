<?php /* Smarty version 2.6.31, created on 2025-04-28 13:39:51
         compiled from /home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 16, false),array('modifier', 'cat', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 33, false),array('modifier', 'df', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 148, false),array('modifier', 'in_array', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 391, false),array('modifier', 'array_search', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 391, false),array('modifier', 'explode', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 428, false),array('modifier', 'pathinfo', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 429, false),array('modifier', 'files', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 452, false),array('modifier', 'replace', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 500, false),array('function', 'customFieldHandler', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 42, false),array('function', 'rlHook', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 368, false),array('function', 'math', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 381, false),array('function', 'getTmpFile', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 489, false),array('function', 'pageUrl', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 530, false),array('function', 'phrase', '/home/gmoplus/public_html/templates/general_sunny/tpl/blocks/field.tpl', 531, false),)), $this); ?>
<!-- fields block -->
...
<?php $this->assign('mixed_cur_val', $this->_tpl_vars['mItem']['pName']); ?><?php break; ?><?php endforeach; endif; unset($_from); ?>" />
                ...
                <?php elseif ($this->_tpl_vars['field']['Type'] == 'price'): ?>
                    <?php if ($this->_tpl_vars['field']['Opt1']): ?>
                        <span class="starting-price-text pr-2 <?php if (! $this->_tpl_vars['fVal'][$this->_tpl_vars['fKey']]['from']): ?>hide<?php endif; ?>"><?php echo $this->_tpl_vars['lang']['price_from']; ?>
</span>
                    <?php endif; ?>
                    ...
                    <input class="numeric price-full"
                            ...
                            size="8"
                            maxlength="15"
                            <?php if ($this->_tpl_vars['fVal'][$this->_tpl_vars['fKey']]['value']): ?>value="<?php echo $this->_tpl_vars['fVal'][$this->_tpl_vars['fKey']]['value']; ?>
"<?php endif; ?>
                    />
...
"
                                        <?php if (( $this->_tpl_vars['currency_item']['Key'] == $this->_tpl_vars['fVal'][$this->_tpl_vars['fKey']]['currency'] ) || ( ! $this->_tpl_vars['fVal'][$this->_tpl_vars['fKey']]['currency'] && $this->_tpl_vars['currency_item']['Default'] )): ?>selected="selected"<?php endif; ?>
                    ...
                    <?php else: ?>
                        <input type="hidden"
                                ...
                                value="<?php $_from = $this->_tpl_vars['currency']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
                            ...
                            <div>
                                <label>
                                    <input class="starting-price"
                                            ...
                                            <?php if ($this->_tpl_vars['fVal'][$this->_tpl_vars['fKey']]['from']): ?>checked="checked"<?php endif; ?>
                                    >
                                    <?php echo $this->_tpl_vars['lang']['starting_price']; ?>

                                </label>
                            </div>
                            <div class="mt-3"><?php echo $this->_tpl_vars['lang']['or']; ?>
</div>
                            <div class="mt-3 mb-2">
                                <?php $_from = ((is_array($_tmp='price_options')) ? $this->_run_mod_handler('df', true, $_tmp) : smarty_modifier_df($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['priceF'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['priceF']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['price_option']):
        $this->_foreach['priceF']['iteration']++;
?>
                                    <div class="d-flex align-items-center<?php if ($this->_foreach['priceF']['iteration'] > 1): ?> mt-2<?php endif; ?>">
                                        <label>
                                            <input class="price-option"
                                                    type="radio"
                                                    value="<?php echo $this->_tpl_vars['price_option']['Key']; ?>
"
                                                    name="f[<?php echo $this->_tpl_vars['field']['Key']; ?>
][option]"
                                                    <?php if ($this->_tpl_vars['fVal'][$this->_tpl_vars['fKey']]['option'] == $this->_tpl_vars['price_option']['Key']): ?>checked="checked"<?php endif; ?>
                                            >
                                            <?php echo $this->_tpl_vars['price_option']['name']; ?>

                                        </label>

                                        <?php if ($this->_tpl_vars['field']['Contact_form_option'] && $this->_tpl_vars['field']['Contact_form_option'] == $this->_tpl_vars['price_option']['Key']): ?>
                                            <img class="qtip ml-3" alt="" title="<?php echo $this->_tpl_vars['lang']['with_popup_desc']; ?>
" src="<?php echo $this->_tpl_vars['rlTplBase']; ?>
img/blank.gif" />
                                        <?php endif; ?>
                                    </div>
