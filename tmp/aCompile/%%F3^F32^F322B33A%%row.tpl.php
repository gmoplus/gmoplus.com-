<?php /* Smarty version 2.6.31, created on 2025-04-08 19:23:28
         compiled from /home/gmoplus/public_html/plugins/loanMortgageCalculator/row.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', '/home/gmoplus/public_html/plugins/loanMortgageCalculator/row.tpl', 9, false),)), $this); ?>
<!-- loan mortgage calculator option -->

<tr>
	<td class="name"><?php echo $this->_tpl_vars['lang']['loanMortgage_option_name']; ?>
</td>
	<td class="field">
		<?php $this->assign('checkbox_field', 'loan_calc'); ?>
		...
		<tr>
			<td>
				<input <?php echo $this->_tpl_vars['loan_calc_yes']; ?>
...
_yes"><?php echo $this->_tpl_vars['lang']['yes']; ?>
				...
				<input <?php echo $this->_tpl_vars['loan_calc_no']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
