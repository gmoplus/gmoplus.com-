<?php /* Smarty version 2.6.31, created on 2025-04-08 21:03:00
         compiled from blocks/field.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'blocks/field.tpl', 23, false),array('modifier', 'df', 'blocks/field.tpl', 101, false),array('modifier', 'explode', 'blocks/field.tpl', 402, false),array('modifier', 'pathinfo', 'blocks/field.tpl', 403, false),array('modifier', 'files', 'blocks/field.tpl', 419, false),array('modifier', 'replace', 'blocks/field.tpl', 450, false),array('modifier', 'cat', 'blocks/field.tpl', 466, false),array('function', 'rlHook', 'blocks/field.tpl', 334, false),array('function', 'getTmpFile', 'blocks/field.tpl', 440, false),array('function', 'pageUrl', 'blocks/field.tpl', 465, false),array('function', 'phrase', 'blocks/field.tpl', 466, false),)), $this); ?>
...
<?php endforeach; endif; unset($_from); ?>
        ...
        <?php elseif ($this->_tpl_vars['field']['Type'] == 'price'): ?>
            <?php if ($this->_tpl_vars['field']['Opt1']): ?>
                <span class="starting-price-text <?php if (! $this->_tpl_vars['fVal'][$this->_tpl_vars['fKey']]['from']): ?>hide<?php endif; ?>"><?php echo $this->_tpl_vars['lang']['price_from']; ?>
</span>
            <?php endif; ?>

            <input class="numeric float price-full"
                    type="text"
                    name="f[<?php echo $this->_tpl_vars['field']['Key']; ?>
][value]"
                    size="8"
...
?>
                            <div <?php if ($this->_foreach['priceF']['iteration'] > 1): ?>class="mt-2"<?php endif; ?>>
                                <label>
...
"
                                ...
                                <?php if ($this->_tpl_vars['field']['Contact_form_option'] && $this->_tpl_vars['field']['Contact_form_option'] == $this->_tpl_vars['price_option']['Key']): ?>
                                    <img class="qtip" alt="" title="<?php echo $this->_tpl_vars['lang']['with_popup_desc']; ?>
