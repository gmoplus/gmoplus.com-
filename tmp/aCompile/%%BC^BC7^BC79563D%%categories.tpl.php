<?php /* Smarty version 2.6.31, created on 2025-04-08 10:01:08
         compiled from controllers/categories.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'rlHook', 'controllers/categories.tpl', 7, false),array('function', 'fckEditor', 'controllers/categories.tpl', 527, false),array('modifier', 'cat', 'controllers/categories.tpl', 18, false),array('modifier', 'replace', 'controllers/categories.tpl', 22, false),array('modifier', 'count', 'controllers/categories.tpl', 427, false),array('modifier', 'escape', 'controllers/categories.tpl', 612, false),array('modifier', 'in_array', 'controllers/categories.tpl', 965, false),)), $this); ?>
...
');
        ...
        $(document).ready(function(){
            ...
            $(\'input.add_variable_button\').click(function(){
                ...
                {
                    if (!$(this).hasClass(\'original-value\')) {
                        variable = \'{\' + variable + \'}\';
                    }
...
"><?php endif; ?>
        ...
        <tr>
            <td class="divider_line" colspan="2">
                <div class="inner"><?php echo $this->_tpl_vars['lang']['metadata']; ?>
</div>
            </td>
        </tr>
...
"><?php endif; ?>
        ...
        <tr>
            <td class="divider_line" colspan="2">
                <div class="inner"><?php echo $this->_tpl_vars['lang']['child_category_metadata']; ?>
</div>
            </td>
        </tr>
        ...
        <tr>
            <td></td>
            <td class="field">
                <div id="child_category_metadata_hint" data-phrase="<?php echo ((is_array($_tmp=$this->_tpl_vars['lang']['child_category_metadata_hint'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
" style="margin: 0 0 4px 0;" class="field_description_noicon"></div>
                ...
                $(function(){
                    var setVars = function(){
                        var $hint = $(\'#child_category_metadata_hint\');
                        var text = $hint.data(\'phrase\');
                        ...
                        if (!text || !key) {
                            ...
                            $hint.html(text.replace(\'{key}\', key).replace(\'{name}\', \'<b>\' + name + \'</b>\'));
                        }
                    }

                    setVars();

                    $(\'input[name=key], input[name^="name"]:first\').keyup(function(){
                        setVars();
                    });
                });
...
?>
                    <?php if (count($this->_tpl_vars['allLangs']) > 1): ?><div class="tab_area<?php if (! ($this->_foreach['langF']['iteration'] <= 1)): ?> hide<?php endif; ?> <?php echo $this->_tpl_vars['language']['Code']; ?>
"><?php endif; ?>
                    <input type="text" name="template_h1[<?php echo $this->_tpl_vars['language']['Code']; ?>
]" value="<?php echo $this->_tpl_vars['sPost']['template_h1'][$this->_tpl_vars['language']['Code']]; ?>
" maxlength="350" class="w350" />
                    <?php if (count($this->_tpl_vars['allLangs']) > 1): ?><span class="field_description_noicon"><?php echo $this->_tpl_vars['lang']['h1_heading']; ?>
 (<b><?php echo $this->_tpl_vars['language']['name']; ?>
</b>)</span><?php endif; ?>
                    <?php if ($_GET['action'] == 'edit'): ?>
                    <div>
                        <select>
                            ...
                            <?php $_from = $this->_tpl_vars['child_category_vars']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['var']):
?>
                                <option value="<?php echo $this->_tpl_vars['var']['key']; ?>
"><?php echo $this->_tpl_vars['var']['name']; ?>
</option>
                            <?php endforeach; endif; unset($_from); ?>
                        </select>
                        <input type="button" class="add_variable_button original-value" value="<?php echo $this->_tpl_vars['lang']['add']; ?>
"/>
                    </div>
                    <?php endif; ?>
                    <?php if (count($this->_tpl_vars['allLangs']) > 1): ?>
...
?>
                    <?php if (count($this->_tpl_vars['allLangs']) > 1): ?><div class="tab_area<?php if (! ($this->_foreach['langF']['iteration'] <= 1)): ?> hide<?php endif; ?> <?php echo $this->_tpl_vars['language']['Code']; ?>
"><?php endif; ?>
                        <input type="text" name="template_title[<?php echo $this->_tpl_vars['language']['Code']; ?>
]" value="<?php echo $this->_tpl_vars['sPost']['template_title'][$this->_tpl_vars['language']['Code']]; ?>
" class="w350" maxlength="250" />
                        <?php if (count($this->_tpl_vars['allLangs']) > 1): ?><span class="field_description_noicon"><?php echo $this->_tpl_vars['lang']['title']; ?>
 (<b><?php echo $this->_tpl_vars['language']['name']; ?>
</b>)</span><?php endif; ?>
                        <?php if ($_GET['action'] == 'edit'): ?>
                        <div>
...
if ($this->_foreach['langF']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['language']):
        $this->_foreach['langF']['iteration']++;
?>
                    <?php $this->assign('lMetaDescription', $this->_tpl_vars['sPost']['template_meta_description']); ?>
                    <?php if (count($this->_tpl_vars['allLangs']) > 1): ?><div class="tab_area<?php if (! ($this->_foreach['langF']['iteration'] <= 1)): ?> hide<?php endif; ?> <?php echo $this->_tpl_vars['language']['Code']; ?>
"><?php endif; ?>
                    <textarea cols="50" rows="2" name="template_meta_description[<?php echo $this->_tpl_vars['language']['Code']; ?>
]"><?php echo $this->_tpl_vars['lMetaDescription'][$this->_tpl_vars['language']['Code']]; ?>
</textarea>
                    <?php if ($_GET['action'] == 'edit'): ?>
                    <div>
...
"/>
        ...
        <tr>
            <td class="divider_line" colspan="2">
                <div class="inner"><?php echo $this->_tpl_vars['lang']['listing_metadata']; ?>
</div>
            </td>
        </tr>
...
?>
                    <?php if (count($this->_tpl_vars['allLangs']) > 1): ?><div class="tab_area<?php if (! ($this->_foreach['langF']['iteration'] <= 1)): ?> hide<?php endif; ?> <?php echo $this->_tpl_vars['language']['Code']; ?>
"><?php endif; ?>
                        <textarea cols="50" rows="2" name="listing_meta_description[<?php echo $this->_tpl_vars['language']['Code']; ?>
]"><?php echo $this->_tpl_vars['sPost']['listing_meta_description'][$this->_tpl_vars['language']['Code']]; ?>
</textarea>
                        <div class="field_description" style="margin: 10px 0 0 0;"><?php echo $this->_tpl_vars['lang']['listing_meta_description_des']; ?>
<?php if (count($this->_tpl_vars['allLangs']) > 1): ?> (<b><?php echo $this->_tpl_vars['language']['name']; ?>
</b>)<?php endif; ?></div>
                        <?php if ($_GET['action'] == 'edit'): ?>
                            <div>
...
"/>
        ...
        <tr>
            <td class="divider_line" colspan="2">
                <div class="inner"><?php echo $this->_tpl_vars['lang']['options']; ?>
</div>
            </td>
        </tr>
