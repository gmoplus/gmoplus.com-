<?php /* Smarty version 2.6.31, created on 2025-04-08 21:03:33
         compiled from /home/gmoplus/public_html/plugins/testimonials/admin/testimonials.tpl */ ?>
<!-- grid -->
        ...
        columns: [
            {
                ...
                header: "'; ?>
<?php echo $this->_tpl_vars['lang']['testimonials_testimonial']; ?>
<?php echo '",
...
<?php echo '\');
                ...
                printMessage(\'error\', "'; ?>
<?php echo $this->_tpl_vars['lang']['system_error']; ?>
<?php echo '");
            }
        })
    }
