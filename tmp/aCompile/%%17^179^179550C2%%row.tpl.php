<?php /* Smarty version 2.6.31, created on 2025-05-25 16:02:15
         compiled from /home/gmoplus/public_html/plugins/street_view/admin/row.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', '/home/gmoplus/public_html/plugins/street_view/admin/row.tpl', 9, false),)), $this); ?>
<!-- street view option -->

<tr>
	<td class="name"><?php echo $this->_tpl_vars['lang']['street_view_tab']; ?>
</td>
	<td class="field">
		<?php $this->assign('checkbox_field', 'street_view'); ?>
		...
		<tr>
			<td>
				<input <?php echo $this->_tpl_vars['street_view_yes']; ?>
...
_yes"><?php echo $this->_tpl_vars['lang']['yes']; ?>
				...
				<input <?php echo $this->_tpl_vars['street_view_no']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
