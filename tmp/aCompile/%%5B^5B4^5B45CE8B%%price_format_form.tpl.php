<?php /* Smarty version 2.6.31, created on 2025-05-30 13:26:04
         compiled from /home/gmoplus/public_html/plugins/shoppingCart/admin/view/price_format_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'df', '/home/gmoplus/public_html/plugins/shoppingCart/admin/view/price_format_form.tpl', 5, false),array('modifier', 'cat', '/home/gmoplus/public_html/plugins/shoppingCart/admin/view/price_format_form.tpl', 30, false),)), $this); ?>
<!-- shoppingCart plugin -->
<tr>
    <td colspan="2">
        <div id="shc-group" class="hide">
            ...
            <table class="form">
                <tr>
                    <td class="name"><span class="red">*</span> <?php echo $this->_tpl_vars['lang']['shc_price_format']; ?>
</td>
...
?>
                            <?php if ($this->_tpl_vars['shcTab']['module']): ?>
                                <?php if (($this->_foreach['FShcTabs']['iteration'] <= 1)): ?>
                                    <?php $this->assign('shc_mode_active', $this->_tpl_vars['shcTab']['module']); ?>
                                <?php endif; ?>
                                <?php if ($_POST['fshc']['shc_mode'] == $this->_tpl_vars['shcTab']['module']): ?>
                                    <?php $this->assign('shc_mode_active', $this->_tpl_vars['shcTab']['module']); ?>
                                <?php endif; ?>
                                <span class="custom-input">
                                    <label>
                                        <input type="radio" <?php if ($this->_tpl_vars['shc_mode_active'] == $this->_tpl_vars['shcTab']['module']): ?>checked="checked"<?php endif; ?> class="numeric wauto" name="fshc[shc_mode]" value="<?php echo $this->_tpl_vars['shcTab']['module']; ?>
