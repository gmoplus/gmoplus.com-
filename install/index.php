...
define('REQUIRE_MIN_VERSION_MYSQL', '5.7');
        ...
        foreach ($advanced as $key => $value) {
            ...
            switch ($value['var']) {
                case 'www_prefix':
                    ...
                    $www_checked = ($_POST['www_prefix'] == '1' || $has_www) ? 'checked="checked"' : '';
                    $non_www_checked = ((isset($_POST['www_prefix']) && $_POST['www_prefix'] != '1') || (!isset($_POST['www_prefix']) && !$has_www)) ? 'checked="checked"' : '';
                ...
                case 'thumbnails_x2':
                    $thumbnails_x2_checked = ($_POST['thumbnails_x2'] == '1' || !isset($_POST['thumbnails_x2'])) ? 'checked="checked"' : '';
                    $non_thumbnails_x2_checked = (isset($_POST['thumbnails_x2']) && $_POST['thumbnails_x2'] != '1') ? 'checked="checked"' : '';
                ...
                case 'https':
                    $is_https = $reefless->isHttps();
                    $https_checked = ($_POST['https'] == '1' || $is_https) ? 'checked="checked"' : '';
                    $https_not_checked = ((isset($_POST['https']) && $_POST['https'] != '1') || (!isset($_POST['https']) && !$is_https)) ? 'checked="checked"' : '';
