...
<article class="item{if $listing.Featured} featured{/if}{if !$pictures_available} no-image{/if} two-inline col-sm-4{if !$side_bar_exists} col-md-3{/if} {rlHook name='tplListingItemClass'}">
    ...
    <div class="main-column clearfix">
        ...
        <ul class="card-info d-flex flex-column position-relative{if $config.sf_display_fields} with-names{/if}">
            <li class="title">
                <a class="link-large"
            ...
            <li class="useful d-flex flex-wrap mt-2">
                {if $config.general_sunny_city_field
                    && $listing.fields[$config.general_sunny_city_field]
                    && $listing.fields[$config.general_sunny_city_field].value
                }
            ...
            <li class="system d-flex flex-wrap">
                ...
                <div>
                    ...
                    <ul class="nav-column d-flex justify-content-end {if !$price.value} stick-top{/if}">
