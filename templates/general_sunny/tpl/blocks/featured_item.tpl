...
<li {if $featured_listing.ID}id="fli_{$featured_listing.ID}"{/if} class="{$box_item_class} d-flex flex-column{if !$featured_listing.Main_photo} no-picture{/if}">
    ...
    <ul class="card-info flex-fill">
        ...
        <li class="fields d-flex">
            ...
            <div class="ml-2">{rlHook name='tplFeaturedItemAdInfo'}</div>
        </li>

        <li class="useful d-flex flex-wrap mt-2">
            {if $config.general_sunny_city_field
                && $featured_listing.fields[$config.general_sunny_city_field]
                && $featured_listing.fields[$config.general_sunny_city_field].value
            }
            ...
            <span class="d-flex align-items-center card-info_posted-date">
                ...
                {toPrettyDateTimeShort date=$featured_listing.Date}
            </span>
        </li>
