...
<div id="nav_bar">
    ...
    {if $aRights.$cKey.add && !$smarty.get.action}
        <a href="{$rlBaseC}action=add" class="button_bar"><span class="left"></span><span class="center-add">{$lang.add_page}</span><span class="right"></span></a>
    {/if}
...
{if $smarty.get.action}
    ...
    <div id="page_url">
        ...
        <tr>
            ...
            <td class="field">
                ...
                {if $smarty.get.action == 'edit' && in_array($sPost.controller, $login_required_page_controllers)}
                    {assign var='login_required' value='disabled="disabled"'}
                    <input type="hidden" name="login" value="1" />
                {/if}

                <label><input {$login_yes} {$login_required} class="lang_add" type="radio" name="login" value="1" /> {$lang.yes}</label>
                <label><input {$login_no} {$login_required} class="lang_add" type="radio" name="login" value="0" /> {$lang.no}</label>

                {if $login_required}
                    <span class="field_description">{$lang.page_login_required_hint}</span>
                {/if}
            </td>
        </tr>
        </table>
    ...
    <tr {if $smarty.get.action == 'edit'
        ...
        <td class="field">
            ...
            <div class="grey_area" style="margin-bottom: 10px;">
                <span onclick="$('#account_types input').prop('checked', true);" class="green_10">{$lang.check_all}</span>
                <span class="divider"> | </span>
                <span onclick="$('#account_types input').prop('checked', false);" class="green_10">{$lang.uncheck_all}</span>
            </div>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="field">
            ...
            <div class="grey_area" style="margin-bottom: 10px;">
                <span onclick="$('.menus input').prop('checked', true);" class="green_10">{$lang.check_all}</span>
                <span class="divider"> | </span>
                <span onclick="$('.menus input').prop('checked', false);" class="green_10">{$lang.uncheck_all}</span>
            </div>
        </td>
    </tr>
