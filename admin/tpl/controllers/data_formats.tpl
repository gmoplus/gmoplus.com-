...
<div id="nav_bar">
    ...
    {if $aRights.$cKey.add}
        {if $smarty.get.mode}
            <a href="javascript:void(0)" onclick="show('new_item');$('#edit_item').slideUp('fast');" class="button_bar"><span class="left"></span><span class="center-add">{$lang.add_item}</span><span class="right"></span></a>
        {elseif !$smarty.get.action}
            <a href="{$rlBaseC}action=add" class="button_bar"><span class="left"></span><span class="center-add">{$lang.add_format}</span><span class="right"></span></a>
...
{else}
    {if $smarty.get.mode === 'manage'}
        ...
        <div id="new_item" class="hide">
            ...
            <tr>
                <td class="name">{if $smarty.get.format === 'price_options'}{$lang.with_popup}{else}{$lang.default}{/if}</td>
                <td class="field">
                    <input type="checkbox" id="ni_default" value="1" />

                    {if $smarty.get.format === 'price_options'}
                        <span class="field_description">{$lang.with_popup_admin_desc}</span>
                    {/if}
                </td>
            </tr>
                ...
                columns: [
                    {
                        ...
                        renderer: function(data) {
                            ...
                            let systemDataFormats = {/literal}{$_systemDataFormats|@json_encode}{literal};
